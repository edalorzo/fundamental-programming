...
public class SavingsAccountRepository implements BankAccountRepository {
    ...
    private final List<SavingsAccount> savingsAccounts = Arrays.asList(
            new SavingsAccount(new AccountNumber("1-234-567-890"), 0.0),
            new SavingsAccount(new AccountNumber("9-876-543-210"), 0.0),
            new SavingsAccount(new AccountNumber("1-236-547-890"), 0.0),
            new SavingsAccount(new AccountNumber("9-874-563-210"), 0.0)
    );
